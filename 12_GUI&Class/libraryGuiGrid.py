...
It uses tkinter, Patron, Book and
Library classes. 
'''
...
class LibraryGridGUI:
    def __init__(self):
        ...
        self.__libraryModel = Library.Library("Megadodo Publications")
...
#___________________________________GRIDS________________________________#
    ...
    def __joinLibrary(self,event):
        ...
        if not self.__libraryModel.isMember(patronName):
            newPatron = Patron.Patron(patronName)
            #print(newPatron)
    ...
    def __addBook(self):
        ...
        if bookTitle and authorName:
            newBook = Book.Book(bookTitle,authorName)
            print(newBook)
