...
def main():  #(line 16)
  ...
  outer_str = input("How many times do you want to execute the outer loop body?"+\
                "\nEnter a whole number or press <ENTER> to quit:  ")
  ...
  while outer_str:
    ...
    middle_str = input("How many times do you want to execute the outer loop body?"+\
                "\nEnter a whole number or press <ENTER> to quit:  ")
    ...
    inner_str = input("How many times do you want to execute the outer loop body?"+\
                "\nEnter a whole number or press <ENTER> to quit:  ")
    ...
    result_list = nested_loops(outer, middle, inner)
