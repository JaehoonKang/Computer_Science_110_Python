...
class Point:
  ...
  # param init_x (int)
  # param init_y (int)
  def __init__(self, init_x = 0, init_y = 0): # set defalut value in the parameters for the situation where the user didn't input a value
    self.__x = init_x # __ is to hide the data element (users should never have the access to the class variables)
    self.__y = init_y 
